...
- forklare et HTML-dokuments grundstruktur og skrive korrekt boilerplate
- anvende tags og attributter korrekt, herunder nesting og void elements
- strukturere indhold med overskrifter, afsnit, lister og sektioner
- indsætte billeder med alt-tekst og forklare forskellen på relative og
  absolutte stier
- linke mellem sider og til sektioner på samme side
- inspicere en side med DevTools og finde/rette simple HTML-fejl
