...
| **D1** | — | **Delaflevering 1: Forstudie og klikbar frontend-mockup** (projektcase afklares) |
...
| 13 | **Web** | Application state: JSON-datastrukturer, sessions |
| 14 | Net | Hvad er internettet: internettet som netværk, netværksforståelse på overordnet niveau |
| 15 | **Web** | REST API'er i Node.js: ressourcer, routes, HTTP-metoder, JSON, CRUD og implementering af API'et i backend |
| 16 | Net | Centrale protokoller på overordnet niveau: HTTP, DNS og en web-forespørgsels vej gennem nettet |
...
| **D2** | — | **Delaflevering 2: MVP** (frontend, backend/API, PostgreSQL, én central brugerhandling) |
...
| 21 | **Web** | IT-sikkerhed: authentication |
| 22 | Net | Sikkerhed og privatliv i digitale systemer: trusselsmodel, angreb, GDPR og sundhedsdata |
...
| **D3** | — | **Delaflevering 3: Fungerende system + authentication + portefølje** |
...
> Udkast — lektionsemnerne er weblærerens forslag. Omfordelingen af
> Net-sporet skal aftales med kursusansvarlig (Rolf Nordahl) og
> netværkssporets lærer; se beslutningsloggen i
> [opdateringsplanen](docs/E26UpdatePlan.md) (D10, D13).
